...
def configure_layout_files(ui_library):
    bs_files = [
        "Components\Layout\HorizontalLayout.razor",
        "Components\Layout\VerticalLayout.razor",
    ]
    tw_files = [
        "Components\Layout\HorizontalLayout-tw.razor",
        "Components\Layout\VerticalLayout-tw.razor",
    ]
